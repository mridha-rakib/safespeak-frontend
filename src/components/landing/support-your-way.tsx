...
import { IconBook2, IconChevronRight, IconClipboardList, IconHeadphones, IconPointer } from "@tabler/icons-react";
...
function CardImageBand({ src, alt }: { src: string; alt: string }) {
  return (
    <div className="relative h-40 overflow-hidden border-b border-[#E8EDF4] bg-[#F5F7FA] sm:h-44">
      <Image src={src} alt={alt} fill sizes="(min-width: 1024px) 35vw, 100vw" className="object-cover" />
    </div>
  );
}
  ...
  return (
    <section className="mx-auto w-full max-w-[1440px] bg-white px-4 py-14 sm:px-8 sm:py-16 lg:px-40 lg:py-20">
      <div className="mx-auto flex w-full max-w-[1120px] flex-col gap-10 lg:gap-16">
        ...
        <div className="grid grid-cols-1 gap-5 sm:gap-6 lg:grid-cols-2 lg:auto-rows-fr lg:gap-x-6 lg:gap-y-8 lg:py-3 lg:[&>*]:transition-transform lg:[&>*:nth-child(even)]:translate-y-3 lg:[&>*:nth-child(odd)]:-translate-y-3">
          <CardShell>
            <CardImageBand
              src={naturalImage}
            ...
            <div className="flex flex-1 flex-col p-6 lg:p-7">
              <div className="flex items-center gap-2 text-[#111827]">
                ...
                <h4 className="text-[28px] font-bold leading-[1.1]">{t("landing.supportYourWay.cards.reportIncident.title")}</h4>
              </div>
          ...
          <CardShell className="p-6 lg:p-7">
            <div className="flex items-center gap-2 text-[#111827]">
              ...
              <h4 className="text-[28px] font-bold leading-[1.1]">{t("landing.supportYourWay.cards.trackCase.title")}</h4>
            </div>
            <p className="mt-4 text-[14px] leading-[1.7] text-[#6B7280]">{t("landing.supportYourWay.cards.trackCase.description")}</p>
          ...
          <CardShell className="p-6 lg:p-7">
            <div className="flex items-center gap-2 text-[#111827]">
              ...
              <h4 className="text-[28px] font-bold leading-[1.1]">{t("landing.supportYourWay.cards.accessResources.title")}</h4>
            </div>
            <p className="mt-4 text-[14px] leading-[1.7] text-[#6B7280]">
          ...
          <CardShell>
            <CardImageBand src={chatWithCounselorImage} alt={t("landing.supportYourWay.cards.chatCounselor.title")} />
            <div className="flex flex-1 flex-col p-6 lg:p-7">
              <div className="flex items-center gap-2 text-[#111827]">
                <IconHeadphones size={16} className="text-[#F29A1F]" />
                <h4 className="text-[28px] font-bold leading-[1.1]">{t("landing.supportYourWay.cards.chatCounselor.title")}</h4>
              </div>
              <p className="mt-4 text-[14px] leading-[1.7] text-[#6B7280]">
